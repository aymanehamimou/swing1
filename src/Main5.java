...
public class Main5 {
    ...
    public static void main(String[] args) {
        ...
        JLabel label_1 = new JLabel("aymane");                 // Label أي قمنا بإنشاء JLabel هنا أنشأنا كائن من الكلاس
        label_1.setFont(newFont);                               // newFont يستخدم الـ label هنا جعلنا الـ

        JLabel label_2 = new JLabel("ahmed");                 // Label أي قمنا بإنشاء JLabel هنا أنشأنا كائن من الكلاس
        label_2.setFont(newFont);                               // newFont يستخدم الـ label هنا جعلنا الـ

        JLabel label_3 = new JLabel("mohamed");                 // Label أي قمنا بإنشاء JLabel هنا أنشأنا كائن من الكلاس
